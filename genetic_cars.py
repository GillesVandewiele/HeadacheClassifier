...
quest = QuestConstructor(default=1, max_nr_nodes=5, discrete_thresh=10, alpha=0.75)
...
for train_index, test_index in skf:
    ...
    best_tree = merger.genetic_algorithm(train_df, 'cat', tree_constructors, seed=SEED, num_iterations=7,
                                                        num_mutations=2, population_size=7)
