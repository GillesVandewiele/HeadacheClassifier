...
class DecisionTree(object):
    ...
    def __init__(self, right=None, left=None, label='', value=None, data=None):
        """
    ...
    def visualise(self, output_path, _view=True):
        """
        ...
        """
        src = Source(self.convert_to_dot())
    ...
    def convert_node_to_dot(self, count=1):
        """
        ...
        if self.value is None:
            ...
            s += self.left.convert_node_to_dot(count=count+1)
